...
from rag_eval.telemetry import TelemetryTracker, _lookup_price, count_tokens
...
class BaseStrategy(ABC):
    ...
    def raw_llm_call(self, prompt: str) -> tuple[str, int, int, float]:
        ...
        cost_usd = (
            prompt_tokens * input_price / 1_000_000 + completion_tokens * output_price / 1_000_000
        )
